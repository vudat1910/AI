...
memory = MemorySaver()
csv_paths = [
    'C:/Users/dat.vuphat/Desktop/topic/data_plus.csv', 
    'C:/Users/dat.vuphat/Desktop/topic/data.csv'
]
pdf_paths = [
    'C:/Users/dat.vuphat/Downloads/mobicloud.pdf',
    'C:/Users/dat.vuphat/Downloads/mobiedu.pdf',
    'C:/Users/dat.vuphat/Downloads/mobigames.pdf'
]
urls = ['https://www.mobifone.vn/dich-vu-di-dong/dich-vu/cliptv-ClipTV']

data_loaders = [CSVLoader(file_path=path, encoding='utf-8') for path in csv_paths] + \
               [PyPDFLoader(file_path=path) for path in pdf_paths] + \
               [WebBaseLoader(web_path=urls)]
...
# Nhập API key
os.environ["TOGETHER_API_KEY"] = 'c24614e35b7e8d9a10dc0d8aacaedc4a18bada764b7ae6aa14117d55b44a2f43'
...
loaded_vectorstore = InMemoryVectorStore.load(
    'vectorstore_data.pkl',
     embedding=embeddings
)
